...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
     ...
     *
     * Se carga un string con el mail y la contraseña
     *
     *
    ...
    /**
     * Se crean variables privadas para enlazarlas con los "widgets" de la pantalla de login
     */
...
*/
    ...
    private boolean isPasswordValid(String password) {
        ...
        // puede ser que haya que cambiar a " password.length() < 4"
        //password.length() < 4
        return false;
    }
     ...
     * the user.
     */
    public class LoginExitoso implements VolleyCallback {
        //UserLoginTask acceso = new UserLoginTask();
    ...
    public class UserLoginTask  {
        ...
        VolleyCallback mListener;

       public void registerEventListener ( VolleyCallback mListener){
            this.mListener = mListener;
           Log.d("registerEventListener", "this.mListener = mListener;");
        }
       ...
       private void doInBackground() {
            ...
            //private VolleyCallback mListener;
